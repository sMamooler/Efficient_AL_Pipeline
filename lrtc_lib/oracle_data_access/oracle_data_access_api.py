...
from  data_access.core.data_structs import Label
...
def sample(dataset_name: str, category_name: str, sample_size: int, random_seed: int, medoids_only=False, cluster_path:str=""):
    """
    ...
    return oracle_utils.sample(dataset_name=dataset_name, category_name=category_name, sample_size=sample_size,
                               random_seed=random_seed, medoids_only=medoids_only, cluster_path=cluster_path)


def sample_positives(dataset_name: str, category_name: str, sample_size: int, random_seed: int, medoids_only=False, cluster_path:str=""):
    """
    ...
    return oracle_utils.sample(dataset_name=dataset_name, category_name=category_name, sample_size=sample_size,
                               random_seed=random_seed, restrict_label=LABEL_POSITIVE, medoids_only=medoids_only, cluster_path=cluster_path)


def sample_negatives(dataset_name: str, category_name: str, sample_size: int, random_seed: int, medoids_only=False, cluster_path:str=""):
    """
    return a sample of TextElements uris with their gold labels information such that all these TextElements have a
    ...
    return oracle_utils.sample(dataset_name=dataset_name, category_name=category_name, sample_size=sample_size,
                               random_seed=random_seed, restrict_label=LABEL_NEGATIVE, medoids_only=medoids_only, cluster_path=cluster_path)
