...
from  data_access import single_dataset_loader
from  orchestrator import orchestrator_api
from  orchestrator.core.state_api import orchestrator_state_api
from  orchestrator.orchestrator_api import BINARY_LABELS
from  orchestrator.test_orchestrator_api import generate_simple_doc
...
class TestOrchestratorStateAPI(unittest.TestCase):
    ...
    def test_copy_workspace(self):
        ...
        orchestrator_state_api.add_model(workspace_id=ws_id, category_name=cat_name, model_id=model_id,
                                         model_status=ModelStatus.READY, model_type=ModelTypes.RAND, model_metadata={})
