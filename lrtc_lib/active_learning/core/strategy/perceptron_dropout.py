...
from  active_learning.core.strategy.perceptron_ensemble import PerceptronEnsemble, \
...
class PerceptronDropout(PerceptronEnsemble):
    ...
    def dropout_predict(self, infer, model):
        from tensorflow.python.keras import backend as K  # see https://github.com/tensorflow/tensorflow/issues/34201
