...
from active_learning.core.strategy.core_set_utils import CoreSetMIPSampling
...
class CoreSetLearner(ActiveLearner):
    ...
    def get_recommended_items_for_labeling(self, workspace_id, model_id, checkpoint_path, dataset_name, category_name, view_dir="", medoids_only=False, sample_size=1):
        ...
        embeddings = np.array(orchestrator_api.infer(workspace_id, category_name, checkpoint_path, X_train)["embeddings"])
