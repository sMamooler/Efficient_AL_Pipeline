...
class ActiveLearningStrategies(object):
    ...
    CLUSTER_AND_MATCH = ActiveLearningStrategy("CLUSTER_AND_MATCH")


def get_compatible_models(model_type, active_learning_strategy):
    embedding_based_models = {ModelTypes.HFBERT, ModelTypes.ROBERTA}
    ...
    embedding_based_strategies = {ActiveLearningStrategies.CORE_SET, ActiveLearningStrategies.DAL,
                                  ...
                                  ActiveLearningStrategies.CLUSTER_AND_MATCH}
