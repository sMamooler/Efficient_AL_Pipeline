...
class ActiveLearningFactory(object):
    ...
    def get_active_learner(self, active_learning_strategy=ActiveLearningStrategies.RANDOM):
        from active_learning.core.strategy import base, retrospective, hard_example_mining, core_set, \
            discriminative_representation_sampling, perceptron_ensemble, perceptron_dropout
        ...
        if active_learning_strategy == ActiveLearningStrategies.RANDOM:
            ...
            raise ValueError("unsupported strategy: " + active_learning_strategy.name)
