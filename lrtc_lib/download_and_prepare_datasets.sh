...
if [ -f "./isear/isear_data.csv" ]; then
  cd "$python_path"
  python -c "import sys; import os; sys.path.append(os.getcwd()); os.chdir(os.path.join(os.getcwd(), 'lrtc_lib')); import  data.load_dataset as loader; loader.load('isear')"
fi

cd "$python_path"
python -c "import sys; import os; sys.path.append(os.getcwd()); os.chdir(os.path.join(os.getcwd(), 'lrtc_lib'));
import  data.load_dataset as loader
