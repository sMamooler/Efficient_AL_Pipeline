...
class LEDGARProcessor(CsvProcessor):

    def __init__(self, dataset_part: DatasetPart, imbalanced_postfix=''):
        super().__init__(dataset_name='ledgar'+imbalanced_postfix, dataset_part=dataset_part, encoding='utf-8')

    def _get_all_categories(self):
        train_file = os.path.join(self.RAW_DATA_BASE_DIR, 'ledgar', 'train.csv')
