...
class OPPProcessor(CsvProcessor):

    def __init__(self, dataset_part: DatasetPart, imbalanced_postfix=''):
        super().__init__(dataset_name='opp'+imbalanced_postfix, dataset_part=dataset_part, doc_id_col="policy_id", encoding='utf-8')

    def _get_all_categories(self):
        train_file = os.path.join(self.RAW_DATA_BASE_DIR, 'opp', 'train.csv')
