...
from  data_access.core.data_structs import Document, Label
import  orchestrator.orchestrator_api as orchestrator_api
...
class DataProcessorAPI(object, metaclass=abc.ABCMeta):
    ...
    LABEL_POSITIVE = orchestrator_api.LABEL_POSITIVE
    LABEL_NEGATIVE = orchestrator_api.LABEL_NEGATIVE
