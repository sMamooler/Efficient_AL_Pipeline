...
from  experiment_runners.experiment_runners_core.assessment.evaluate_predictions import evaluate_predictions
from  experiment_runners.experiment_runners_core.utils import get_output_dir
...
def generate_performance_metrics_dict(config, evaluation_dataset):
    ...
    predicted_labels = orchestrator_api.infer(config.workspace_id, config.category_name, config.ckpt_path, all_text_elements)
